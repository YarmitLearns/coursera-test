...
var insertProperty = function (string, propName, propValue) {
  ...
  console.log("Thanks for grading! Hope you enjoyed the class.")
  return string;
};
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  // ~~~~~~!!! ASSIGNMENT !!!!~~~~~~~ \\
  // Telling ajax to get our json and what to do with it
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(homeHtmlUrl, function (homeHtml) {
    // Get a random category's short name
    var chosenCategoryShortName = chooseRandomCategory(categories).short_name;
    // Preparing short name for insertion. (I tried '"' at first... didn't work out so well)
    var chosenCategoryShortName ="'" + chosenCategoryShortName + "'";
    // Loading our snippet with the random category's short name
    var homeHtmlToInsertIntoMainPage = insertProperty(homeHtml, "randomCategoryShortName", 
                                                      chosenCategoryShortName);
    // Inserting our work into the main page
